...
import { SERIES, fmtMW, fmtTime, fmtHourOrDay } from '../theme'
  ...
  return (
    <div className="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
      <ResponsiveContainer width="100%" height={160}>
        <ComposedChart data={data} syncId="fc" margin={{ top: 8, right: 56, left: 0, bottom: 0 }}>
          ...
          <YAxis tickFormatter={fmtMW} tick={{ fontSize: 10, fill: ink }} width={58}
          ...
          <Area dataKey="band" stackId="band" stroke="none" fill={color} fillOpacity={dark ? 0.25 : 0.16} isAnimationActive={false} />
